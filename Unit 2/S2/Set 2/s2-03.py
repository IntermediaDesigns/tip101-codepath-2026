...
#
#    Write a function that takes in a dictionary of items and a price_threshold as
#    parameters. The function should iterate through the dictionary and remove all items
#    that have a value less than price_threshold. The function also returns a list of all
